...
import { boobDesc, nipDesc, skinDesc, legDesc } from '../content/Descriptions.ts'
import { clothesTop, pullUD } from '../content/Clothes.ts'

export function doJungle(): void {
  const chance = eventSelect('Jungle')

  if (chance === 1) {
    // Rolling down the hill — discover Valley
    ...
    // Tentacle encounter (same as Forest)
